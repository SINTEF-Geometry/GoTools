...
// Description: Benchmark the point evaluation (with higher derivs) for a LRSplineVolume.  If input is a regular
// SplineVolume, we convert to LRSplineVolume and compare. If input is a LRSplineVolume, we compare with the
// corresponding (refined) SplineVolume.
