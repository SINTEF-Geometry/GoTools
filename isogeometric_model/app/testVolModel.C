...
int main( int argc, char* argv[] )
{
  ...
  for (ki=0; ki<nmb_blocks; ++ki)
  {
      ...
      shared_ptr<BasisDerivs> basis_derivs;
	  ...
	  for (kq = 0; kq < num_coefs_v; ++kq)
	      ...
	      shared_ptr<BasisDerivs> basis_derivs2;
	      ...
	      sol->getBasisFunctionValues(basis_func_id_u, basis_func_id_v, basis_func_id_w,
					  ...
					  basis_derivs2);
	      vector<double>& val2 = basis_derivs->basisValues;
	      vector<double>& der2_u = basis_derivs->basisDerivs_u;
	      vector<double>& der2_v = basis_derivs->basisDerivs_v;
	      vector<double>& der2_w = basis_derivs->basisDerivs_w;
