...
//===========================================================================
void gvView::viewAxiometric()
//===========================================================================
{
    focusOnBox();
    camera_.rotate(1.0, 0.0, -90.0);
    camera_.rotate(0.0, 1.0, -45.0);
    camera_.rotate(1.0, 0.0, 30.0);

}


//===========================================================================
void gvView::viewFront()
//===========================================================================
{
    focusOnBox();
    const double angle = 360.0*0.25;//M_PI*0.3;
    camera_.rotate(1.0, 0.0, -angle);
...
//===========================================================================
{
    focusOnBox(); // This is the top view.
}


//===========================================================================
void gvView::viewRight()
//===========================================================================
{
    focusOnBox();
    const double angle = 360.0*0.25;//M_PI*0.3;
    camera_.rotate(1.0, 0.0, -angle);
    camera_.rotate(0.0, 1.0, -angle);

}


//===========================================================================
void gvView::viewRear()
//===========================================================================
{
    focusOnBox();
    const double angle = 360.0*0.25;//M_PI*0.3;
    camera_.rotate(1.0, 0.0, -angle);
    camera_.rotate(0.0, 1.0, -2.0*angle);

}


//===========================================================================
void gvView::viewBottom()
//===========================================================================
{
    focusOnBox();
    const double angle = 360.0*0.5;//M_PI*0.3;
    camera_.rotate(1.0, 0.0, angle);
