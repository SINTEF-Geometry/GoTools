...
struct gvColor
{
    ...
    {
	setVal(Int2Type< std::is_floating_point<NumericType>::value >(),
	       r, g, b);
    }
    template <typename NumericType>
    gvColor(NumericType r, NumericType g, NumericType b,
    ...
    {
       gvColor ret;
       ret.setHsva(Int2Type< std::is_floating_point<NumericType>::value >(),
		   h, s, v, alpha);
       return ret;
    }
...
private:
		...
		NumericType alpha)
   {
      ...
      setHsva(Int2Type< std::is_floating_point<float>::value >(),
	      fh,fs,fv,fa);
   }
