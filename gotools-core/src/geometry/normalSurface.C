...
//                                                                          
// Revision: $Id: normalSurface.C,v 1.4 2005-02-25 11:58:04 afr Exp $
//                                                                          
// Description: Makes the normal surface corresponding to a surface as
//              described in :
//              Computing normal vector Bezier patches. Przemyslaw Kiciak,
//              Computer Aided Design 18 (2001), 699-710.
//
// Method       For nonrational surfaces the normal surface is
//              
//              N = P x P   where P is the input surface.
//                   U   V
//
//              If P is of degree m x n, N is of degree 2m-1 x 2n-1.
//
//              In the rational case, setting  P(U,V) = T(U,V) / w(U,V), 
//              we find
//
//                                                     4
//                  N = P xP =(wT -w T) x (wT -w T) / w
//                       U  V    U  U        V  V
//
//                                                      3
...
//                               U  V  U V    V   U
//
//              If P is of degree m x n, N is of degree 3m-1 x 3n-1,
//              but can be reduced to degree 3m-2 x 3n-2.
//              
//==========================================================================
